            ...
            if (!querySnapshot.empty) {
                ...
                querySnapshot.forEach((docSnap) => {
                    ...
                    el.innerHTML = `
                        ...
                        <div class="gallery-overlay"><i class="fa-brands fa-instagram"></i></div>
                    `;
                    galleryContainer.appendChild(el);
                    delay++;
                });
            } else {
                galleryContainer.innerHTML = '<p style="grid-column: 1/-1; text-align: center;">Belum ada foto galeri.</p>';
            }
        } catch (e) {
            console.error("Error fetching gallery:", e);
            galleryContainer.innerHTML = '<p style="grid-column: 1/-1; text-align: center; color: var(--clr-primary);">Gagal memuat galeri. Pastikan konfigurasi Firebase sudah benar.</p>';
        }
    }
